...
public class Gallery {
	@Id
	@SequenceGenerator(name = "gallery_sequence", sequenceName = "gallery_sequence", allocationSize = 1)
	...
	public Gallery(String titoloSaga) {

		this.titoloSaga = titoloSaga;
	}

	public Gallery(String titoloSaga, List<LibriGame> libriGame) {
		super();
		this.titoloSaga = titoloSaga;
		this.libriGame = libriGame;
	}
